...
class bern_emb_data():
    def __init__(self, cs, ns, fpath, dynamic, n_epochs=1, remove_stopwords=False):
        ...
        # change to reflect correct argument for open pickle file and its location

        self.T = len(dat_stats['T_bins'])
        self.name = dat_stats['name']
        self.time_interval = dat_stats['T_bins']
        print("data.py value of dynamic: %r" % self.dynamic)
	...
	# load vocabulary
        # change to locate vocabulary file based on fpath from args.py
